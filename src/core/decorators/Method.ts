...
import type { NodeMethodConfig } from '../config';
...
export function Method(config?: NodeMethodConfig) {
  return function (target: object, propertyKey: string, descriptor: PropertyDescriptor) {
    ...
    //将Endpoint写入Method
    const constructor = target.constructor as unknown as Record<string, Array<Endpoint>>;
